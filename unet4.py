...
#c5 = keras.layers.Conv2D(IMG_HEIGHT, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(p4)
#c5 = keras.layers.Dropout(0.3)(c5)
#c5 = keras.layers.Conv2D(IMG_HEIGHT, (3, 3), activation='relu', kernel_initializer='he_normal', padding='same')(c5)
