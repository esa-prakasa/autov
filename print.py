...
TRAIN_PATH = r'/home/lgr0220157/unetcsc/train'
TEST_PATH = r'/home/lgr0220157/unetcsc/test'
...
results = modelRd.fit(X_train, Y_train, validation_split=0.2, batch_size=16, epochs=100, callbacks=callbacks)
...
with open(os.path.join(r'/home/lgr0220157/unetcsc/model',modelJsonFileNm), "w") as json_file:
    json_file.write(model_json)

modelRd.save_weights(os.path.join(r'/home/lgr0220157/unetcsc/model',modelH5FileNm))
...
pathToSave = r'/home/lgr0220157/unetcsc/result'
...
for imgIdx in range(30):
    ...
    resultFileName = maskFileList[imgIdx]+'.png'
