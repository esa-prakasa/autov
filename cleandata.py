...
path ="C:\\Users\\INKOM06\\Pictures\\roadDataset\\bandung\\Purbaleunyi_Highway_1\\ds\\_B\\"
cleanPath ="C:\\Users\\INKOM06\\Pictures\\roadDataset\\bandung\\Purbaleunyi_Highway_1\\ds\\_B3\\"
...
for i in  range(Nf):
	...
	if dim == dimRef:
		cv2.imwrite(cleanPath+files[i],img)
		idc = idc + 1

print("%d images with size [%s] have been separated from %d dataset"%(idc,dimRef,Nf))
