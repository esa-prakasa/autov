...
TRAIN_PATH = r'/home/lgr0220157/unettopcam/fold3/train'
TEST_PATH = r'/home/lgr0220157/unettopcam/fold3/test'
...
################################
#Modelcheckpoint
modelPath = r'/home/lgr0220157/unettopcam/model'
...
with open(os.path.join(r'/home/lgr0220157/unettopcam/model',modelJsonFileNm), "w") as json_file:
    json_file.write(model_json)

modelRd.save_weights(os.path.join(r'/home/lgr0220157/unettopcam/model',modelH5FileNm))
...
pathToSave = r'/home/lgr0220157/unettopcam/result'
